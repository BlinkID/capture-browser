...
import { uiStateMap } from "capture-main";
    ...
    >
      ...
      <Show
        when={
          ...
          sdkStore.uiState.key === uiStateMap.FLIP_CARD.key ||
      ...
      <div class={logoPositionerStyles}>
        <MicroblinkLogo class={logoStyles} />
      </div>

      <HelpButton />

      <video class={videoStyles} ref={videoRef!} src="" />
    </div>
  );
};
